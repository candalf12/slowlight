...
- **← / →** — nudge the heading. Optional. Let go and the boat settles back to
  sailing itself; steering is never required and never needed.
...
place; a different seed sets out from different water, at a different hour,
past different land. With no seed in the URL one is picked and written back, so
you can always return to the world you were watching. The current seed sits in
